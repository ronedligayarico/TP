...
<hr>
	<div class="form-row">
		...
		<div class="col-md-10">
			<p><b>The <span style="color: green;">Correct answer</span>  of each question is the filled radiobutton.</b> 		
			<br>
			<b>Items : <%=countQuestion%></b>
			</p>
			...
			<div class="row">
				...
				<%
					...
					while(rsSelect.next())
					{
						...
						int correctAns = Integer.parseInt(correct_ans);
				...
				<input class="corAns" value="<%=correct_ans%>" hidden>
					...
					<%
						...
						while(rsSelect1.next())
						{
							...
							letterCount++;
							if(correctAns == letterCount)
							{

					%>
						<div class="col-md-5 left">
							<input type="radio" name="<%=numCount%>" value="<%=choices_val%>" class="radio ansList" id="inputRad" checked> 
							<%
							if(letterCount == 1)
							{
								%>
					...
					<%
							...
							else
							{
								%>
						<div class="col-md-5 left">
							<input type="radio" name="<%=numCount%>" value="<%=choices_val%>" class="radio ansList" id="inputRad" disabled> 
							<%
							if(letterCount == 1)
							{
								%>
		...
		<div class="col-lg-10">
			...
			<button class="btn btn-success btn-fill" onclick="reloadCategory()">Back to Category</button>
		</div>
		<div class="col-lg-1">
		</div>
	</div>
